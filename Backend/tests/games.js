...
Test('/games/', function (t) {
  ...
  Parser.validate(apiPath, function (err, api) {
    ...
    /**
         ...
         * responses: default
         */
    t.test('test createGame post operation', function (t) {
      Mockgen().requests({
        path: '/games/',
        operation: 'post'
      }, function (err, mock) {
         ...
         * responses: 200
         */
    t.test('test getAllGames get operation', function (t) {
      Mockgen().requests({
        path: '/games/',
        operation: 'get'
      }, function (err, mock) {
        ...
        request.end(function (err, res) {
          ...
          let validate = Validator(api.paths['/games/']['get']['responses']['200']['schema'])
