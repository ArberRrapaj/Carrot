...
/**
 * Test for /recensions/game/{gameId}
 */
Test('/recensions/game/{gameId}', function (t) {
  ...
  Parser.validate(apiPath, function (err, api) {
    ...
    /**
         ...
         */
    t.test('test getRecensionByGameId get operation', function (t) {
      Mockgen().requests({
        path: '/recensions/game/{gameId}',
        operation: 'get'
      }, function (err, mock) {
        let request
        t.error(err)
        ...
        request.end(function (err, res) {
          ...
          let validate = Validator(api.paths['/recensions/game/{gameId}']['get']['responses']['200']['schema'])
