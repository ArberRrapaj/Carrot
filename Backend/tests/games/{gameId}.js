...
/**
 * Test for /games/{gameId}
 */
Test('/games/{gameId}', function (t) {
  ...
  Parser.validate(apiPath, function (err, api) {
    ...
    /**
         ...
         */
    t.test('test getGameById get operation', function (t) {
      Mockgen().requests({
        path: '/games/{gameId}',
        operation: 'get'
      }, function (err, mock) {
        ...
        request.end(function (err, res) {
          ...
          let validate = Validator(api.paths['/games/{gameId}']['get']['responses']['200']['schema'])
         ...
         * responses: 405
         */
    t.test('test updateGame put operation', function (t) {
      Mockgen().requests({
        path: '/games/{gameId}',
        operation: 'put'
      }, function (err, mock) {
         ...
         * responses: 400, 404
         */
    t.test('test deleteGame delete operation', function (t) {
      Mockgen().requests({
        path: '/games/{gameId}',
        operation: 'delete'
      }, function (err, mock) {
