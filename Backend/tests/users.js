...
Test('/users', function (t) {
  ...
  Parser.validate(apiPath, function (err, api) {
    ...
    /**
         ...
         * responses: default
         */
    t.test('test createUser post operation', function (t) {
      Mockgen().requests({
        path: '/users',
        operation: 'post'
      }, function (err, mock) {
         ...
         * responses: 200
         */
    t.test('test getAllUser get operation', function (t) {
      Mockgen().requests({
        path: '/users',
        operation: 'get'
      }, function (err, mock) {
        ...
        request.end(function (err, res) {
          ...
          let validate = Validator(api.paths['/users']['get']['responses']['200']['schema'])
